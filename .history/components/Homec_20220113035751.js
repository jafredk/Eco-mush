function Homec() {
    ...
    <div class="container px-6 py-10 mx-auto">
        <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">explore our  awesome <span class="underline decoration-blue-500">Services</span></h1>
